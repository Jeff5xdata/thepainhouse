<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select wire:model="timeRange" id="timeRange" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 sm:text-sm rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
        ...
        <div class="mt-6 bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 mb-4">Chart Information</h3>
        ...
        <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <a href="{{ route('weight.tracker') }}" class="relative group bg-white dark:bg-gray-800 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 dark:focus-within:ring-blue-400 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <div>
            ...
            <a href="{{ route('body.measurements') }}" class="relative group bg-white dark:bg-gray-800 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 dark:focus-within:ring-blue-400 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <div>
                    <span class="rounded-lg inline-flex p-3 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 ring-4 ring-white dark:ring-gray-800">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('workout.progress') }}" class="relative group bg-white dark:bg-gray-800 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 dark:focus-within:ring-blue-400 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <div>
                    <span class="rounded-lg inline-flex p-3 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 ring-4 ring-white dark:ring-gray-800">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('nutrition') }}" class="relative group bg-white dark:bg-gray-800 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 dark:focus-within:ring-blue-400 rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
                <div>
    ...
    <script>
        ...
        function initChart() {
            ...
            // Apply dark mode styling to chart options
